module FRGLatticeEvaluation
    ...
    include("Fourier.jl")
    export AbstractLattice, LatticeInfo,FourierTransform, Fourier2D,Fourier3D,  getFlow, getMaxFlow, pointPath, fetchKPath,getkMax,CorrelationLength,maxCorrelationLength
